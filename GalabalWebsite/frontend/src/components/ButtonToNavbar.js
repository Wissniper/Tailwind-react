...
import imgNavButton from "../assets/navButton.png";
  ...
  return (
    <div>
      <button
        ...
        className="fixed bottom-20 right-0 bg-transparent border-none cursor-pointer z-50"
      >
        <img
          src={imgNavButton}
          alt="Nav Button"
          className="h-10 w-10 opacity-90 hover:opacity-90"
        />
      </button>
